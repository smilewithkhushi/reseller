...
export function ProductAuditTrail() {
  ...
  // Get product details
  const { data: productData, isError: productError, isLoading: productLoading } = useContractRead({
  ...
  const { data: invoicesData, isLoading: invoicesLoading } = useContractRead({
    address: CONTRACT_ADDRESS as `0x${string}`,
    abi: CONTRACT_ABI,
  ...
  const { data: transfersData, isLoading: transfersLoading } = useContractRead({
    address: CONTRACT_ADDRESS as `0x${string}`,
    abi: CONTRACT_ABI,
